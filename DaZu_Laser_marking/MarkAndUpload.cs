                                              ...
                                              List<string> Equpments)
        {
            ...
            if (status.IsRecode == false)
            {
                ...
                try
                {
                    var jsonObj1 = JObject.Parse(res1.Replace("#", ""));
                    var jsonObj2 = JObject.Parse(res2.Replace("#", ""));
                    var jsonObj3 = JObject.Parse(res2.Replace("#", ""));
                    var jsonObj4 = JObject.Parse(res2.Replace("#", ""));

                    if (jsonObj1["status"].ToString() == "success" && jsonObj2["status"].ToString() == "success" && jsonObj3["status"].ToString() == "success" && jsonObj4["status"].ToString() == "success")
                    {
                        status.Res = "写入成功!" + "\n" + status.Res;
                        status.QrcodeUpdate1 = 2;

                        string res = await DB.StartMarking(Equpments);
                        var jsonObj = JObject.Parse(res.Replace("#", ""));
            ...
            else
            {
                ...
                try
                {
                    var jsonObj1 = JObject.Parse(res1.Replace("#", ""));
                    var jsonObj2 = JObject.Parse(res2.Replace("#", ""));
                    var jsonObj3 = JObject.Parse(res3.Replace("#", ""));
                    var jsonObj4 = JObject.Parse(res4.Replace("#", ""));
